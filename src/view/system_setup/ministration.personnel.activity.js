...
export default class MinistrationPersonnelActivity extends BaseTableActivityComponent {
    ...
    loadNetWorkData(page: number): Array {
        ...
        NetworkCommonUtil.httpPostRequest(JSON.stringify(param), NetworkCommonUtil.API_ADS_CONFIG_FIND_PAGES).then((data: any) => {
    ...
    netWorkCreateNew(): boolean {
        ...
        NetworkCommonUtil.httpPostRequest(JSON.stringify(param), NetworkCommonUtil.API_ADS_CONFIG_CREATE).then((data: any) => {
            // DialogCommonManage.showNormalMessage(JSON.stringify(data));
            if (data && data.code === NetworkCommonUtil.SERVER_HTTP_TASK_STATUS_SUCCESS) {
    ...
    netWorkDeleteOld(data: any, index: number): boolean {
        ...
        NetworkCommonUtil.httpPostRequest(JSON.stringify(param), NetworkCommonUtil.API_ADS_CONFIG_DELETE).then((data: any) => {
            // DialogCommonManage.showNormalMessage(JSON.stringify(data));
            if (data && data.code === NetworkCommonUtil.SERVER_HTTP_TASK_STATUS_SUCCESS) {
