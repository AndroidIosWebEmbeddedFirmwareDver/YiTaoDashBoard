...
class OrderCommondityActivityEditModalContent extends BaseActivityComponent {
...
export default class OrderCommondityActivity extends BaseTableActivityComponent {
    ...
    loadNetWorkData(page: number): Array {
        ...
        NetworkCommonUtil.httpPostRequest(JSON.stringify(param), NetworkCommonUtil.API_RELEASE_MANAGEMENT_OF_COMMONIDITY_FIND_PAGES).then((data: any) => {
            // DialogCommonManage.showNormalMessage(JSON.stringify(data));
            if (data && data.code === NetworkCommonUtil.SERVER_HTTP_TASK_STATUS_SUCCESS) {
                if (data.data) {
    ...
    changeOrderStatus(data: any, status): boolean {
        ...
        NetworkCommonUtil.httpPostRequest(JSON.stringify(param), NetworkCommonUtil.API_RELEASE_MANAGEMENT_OF_COMMONIDITY_CHANGE_STATUS).then((data: any) => {
            // DialogCommonManage.showNormalMessage(JSON.stringify(data));
            if (data && data.code === NetworkCommonUtil.SERVER_HTTP_TASK_STATUS_SUCCESS) {
    ...
    modalOnGengerModalContent(): * {
        return (
            <OrderCommondityActivityEditModalContent
